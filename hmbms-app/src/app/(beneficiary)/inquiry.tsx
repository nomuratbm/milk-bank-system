            ...
            <View style={styles.scrollContent}>
                ...
                <View style={styles.stepCard}>
                    <View style={styles.iconCircleContainer}>
                        <View style={[styles.circleGraphicBackground, { backgroundColor: theme.primaryLight }]} />
                        <View style={styles.iconWrapper}>
                            <Svg width="43" height="43" fill="none" viewBox="0 0 43 43">
                                <G stroke="#000000" strokeWidth="2.5">
                                    ...
                                    <Path d="M16.125 16.125h10.75M16.125 23.292h10.75M16.125 30.458h7.167" strokeLinecap="round" />
                                </G>
                            </Svg>
                        </View>
                    </View>
                    ...
                    <View style={styles.iconCircleContainer}>
                        ...
                        <View style={styles.iconWrapper}>
                            <Svg width="36" height="36" fill="none" viewBox="0 0 40 40">
                                <G stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5">
                ...
                {/* CTA Banner */}
                <View style={[styles.ctaBannerContainer, { backgroundColor: theme.accent }]}>
...
const styles = StyleSheet.create({
    ...
    scrollContent: { paddingHorizontal: 24, paddingTop: 0, marginTop: -8, paddingBottom: 40 },
    mainHeading: { fontSize: 24, fontWeight: '600', color: '#000000', marginBottom: 6 },
    subHeading: { fontSize: 16, fontWeight: '300', color: '#333333', marginBottom: 24 },
    howItWorksHeading: { fontSize: 18, fontWeight: '500', fontStyle: 'italic', color: '#000000', marginBottom: 16 },
    stepCard: { flexDirection: 'row', backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E3E3E3', borderRadius: 12, padding: 16, marginBottom: 16, alignItems: 'center' },
    iconCircleContainer: { position: 'relative', width: 60, height: 60, justifyContent: 'center', alignItems: 'center', marginRight: 16 },
    circleGraphicBackground: { position: 'absolute', width: 60, height: 60, borderRadius: 30 },
    iconWrapper: { position: 'absolute', zIndex: 5 },
    cardTextContent: { flex: 1 },
    stepLabel: { fontSize: 14, fontWeight: '500', fontStyle: 'italic', color: '#666666', marginBottom: 2 },
    stepTitle: { fontSize: 17, fontWeight: '600', color: '#000000', marginBottom: 4 },
    stepDescription: { fontSize: 13, fontWeight: '300', color: '#444444', lineHeight: 17 },
    ctaBannerContainer: { flexDirection: 'row', borderWidth: 1, borderColor: '#1E1E1E', borderRadius: 12, padding: 18, alignItems: 'center', justifyContent: 'space-between', marginTop: 8, marginBottom: 32 },
    ctaTextContainer: { flex: 1 },
    ctaLabel: { fontSize: 14, fontWeight: '500', fontStyle: 'italic', color: '#000000', marginBottom: 2 },
    ctaTitle: { fontSize: 17, fontWeight: '600', color: '#000000', marginBottom: 4 },
    ctaDescription: { fontSize: 13, fontWeight: '300', color: '#000000' },
    ctaArrowCircle: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center', overflow: 'hidden', paddingLeft: 7, paddingTop: 1 },
    contactFormTitle: { fontSize: 24, fontWeight: '600', color: '#000000', marginBottom: 16 },
    inputGroup: { width: '100%', marginBottom: 16 },
    inputLabel: { fontSize: 13, fontWeight: '300', color: '#000000', marginBottom: 6 },
    textInput: { width: '100%', height: 46, borderWidth: 1, borderColor: '#D9D9D9', borderRadius: 8, paddingHorizontal: 16, fontSize: 15, color: '#000000', backgroundColor: '#FFFFFF' },
    textAreaInput: { height: 120, paddingTop: 12, paddingBottom: 12 },
    submitButton: { width: '100%', height: 48, borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginTop: 16 },
    submitButtonText: { fontSize: 16, fontWeight: '700', color: '#1E1E1E' },
});
