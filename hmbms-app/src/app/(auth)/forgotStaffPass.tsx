...
const ForgotPasswordPreInputStaff: React.FC = () => {
        ...
        <SafeAreaView style={globalStyles.container}>
            ...
            <ScrollView style={[globalStyles.bottomSection, { backgroundColor: theme.primaryBg }]} contentContainerStyle={globalStyles.scrollContent}>
                ...
                <View style={globalStyles.buttonContainerShort}>
                    <TouchableOpacity style={[globalStyles.actionButton, { backgroundColor: theme.accent }]} activeOpacity={0.8} onPress={() => router.push('/forgotPasswordSuccessfullySentStaff')}>
...
export default ForgotPasswordPreInputStaff;