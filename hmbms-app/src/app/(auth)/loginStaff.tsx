      ...
      >
        ...
        <View className="flex-row justify-between items-center mb-8">
          ...
          <View className="flex-row items-center border border-white/30 rounded-xl px-2.5 py-1.5 bg-navy-badge">
            ...
            />
            <Text className="text-ink-400 text-[10px] font-bold">Staff Login</Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/forgotStaffPass")}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/signupStaff")}
        >
