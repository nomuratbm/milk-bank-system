            ...
            <ScrollView style={[globalStyles.bottomSection, { backgroundColor: theme.primaryBg }]} contentContainerStyle={globalStyles.scrollContent}>
                <View style={globalStyles.headerRow}>
                    ...
                    <View style={[globalStyles.badgeContainer, { backgroundColor: theme.badgeBg }]}>
                        ...
                        <Text style={globalStyles.badgeText}>{"Staff Login"}</Text>
                    </View>
                </View>
                ...
                <TouchableOpacity style={globalStyles.forgotPasswordContainer} onPress={() => router.push('/forgotStaffPass')}>
                ...
                <TouchableOpacity style={globalStyles.redirectContainer} onPress={() => router.push('/signupStaff')}>
