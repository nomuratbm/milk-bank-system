...
export const THEME_TOKENS = {
    staff: {
        primaryBg: '#0D072F',   // Original Dark Blue
...
// Reusable Top Graphic Section with your exact high-fidelity path structures untouched
export const TopBrandingSection: React.FC = () => {
    return (
        <View style={globalStyles.topSection}>
            <View style={globalStyles.logoContainer}>
                {/* Fixed width to 112 and offset viewBox to keep the right edge pixel-perfect */}
