// src/components/TopBrandingSection.tsx
...
const TopBrandingSection: React.FC = () => {
  return (
    <View className="h-[32vh] bg-white justify-center items-center relative">
      {/* Logo */}
      <View className="mt-2.5 mb-9 items-center">
        <Svg width="112" height="160" viewBox="-1 0 112 160" fill="none">
          ...
          <Defs>
            <ClipPath id="clip0">
              <Path fill="#fff" d="M0 0h112v160H0z" />
            </ClipPath>
          </Defs>
        </Svg>
      </View>
...
export default TopBrandingSection;